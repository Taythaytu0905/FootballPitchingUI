        ...
        <v-tab-item value="register">
          <v-form ref="register">
            <v-container fluid class="ma-0 pa-0">
              ...
              <v-row>
                <v-col cols="3">
                  <v-subheader class="font-weight-bold pt-6 px-0">Email <span class="red--text">&ensp;*</span>
                  </v-subheader>
                </v-col>
                <v-col cols="9">
                  <v-text-field
                ...
                <v-col cols="3">
                  <v-subheader class="font-weight-bold pt-6 px-0">Phone <span class="red--text">&ensp;*</span>
                  </v-subheader>
                </v-col>
                <v-col cols="9">
                  <v-text-field
                ...
                <v-col cols="3">
                  <v-subheader class="font-weight-bold pt-6 px-0">Password<span class="red--text">&ensp;*</span>
                  </v-subheader>
                </v-col>
                <v-col cols="9">
                  <v-text-field
                ...
                <v-col cols="9">
                  <p class="register-caption">Press Register plz <a href="#" style="color: #08855B;">Term and policy</a>
                  </p>
                </v-col>
